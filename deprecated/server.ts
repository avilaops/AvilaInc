...
// @ts-ignore
// import railwayRoutes from './routes/railway.routes.ts';
// @ts-ignore
// import azureRoutes from './routes/azure.routes.ts';
// @ts-ignore
// import sentryRoutes from './routes/sentry.routes.ts';
// @ts-ignore
// import dnsRoutes from './routes/dns.routes.ts';
// @ts-ignore
// import paypalRoutes from './routes/paypal.routes.ts';
// @ts-ignore
import linkedinRoutes from './routes/linkedin.routes.ts';
// @ts-ignore
import cloudflareRoutes from './routes/cloudflare.routes.ts';
// @ts-ignore
...
console.log('✅ Conexão MongoDB iniciada');
...
// LinkedIn Routes
// console.log('🔄 Registrando rota LinkedIn...');
// app.use('/api/linkedin', linkedinRoutes);
// console.log('✅ Rota LinkedIn registrada');

// Cloudflare Routes
// app.use('/api/cloudflare', cloudflareRoutes);

// OpenAI Routes
// console.log('🔄 Registrando rota OpenAI...');
// app.use('/api/openai', openaiRoutes);
// console.log('✅ Rota OpenAI registrada');
