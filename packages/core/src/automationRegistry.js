...
exports.automationCapabilities = exports.automationCatalog = void 0;
exports.automationCatalog = [
    {
...
exports.automationCapabilities = exports.automationCatalog.flatMap((category) => category.capabilities.map((capability) => ({
    category: category.label,
    icon: category.icon,
    ...capability,
})));
//# sourceMappingURL=automationRegistry.js.map